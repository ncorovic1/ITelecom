...
@section('title')
<title> Dnevnik prijava — ITelecom </title>
@endsection
...
<?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                foreach ($login_attempts as $attempt) {
                    ...
                    $html .= "<td>$counter</td>";
                    $html .= "<td>".$attempt['id']."</td>";
                    
                    $html .= "<td>".$attempt['email']."</td>";
                    $html .= "<td>".$attempt['ip_address']."</td>";
                    $html .= "<td>".date('d.m.Y H:i:s', $attempt['created_at']->getTimestamp())."</td>";
                    $html .= "<td>";
                    if ($attempt['login_result'] == 'SUCCESSFUL') {
                        $html .= "USPJEH";
                    }
                    else {
                        $html .= "NEUSPJEH";
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Dnevnik prijava i pokušaja prijava na sistem
                            </h3>
                        </div>
                                ...
                                <div class="col-md-10">
                                    <nav class="navbar navbar-default" role="navigation">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            <form method="GET" action="/dnevnik-prijava" class="navbar-form navbar-left" role="search">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($login_attempts as $attempt)
                                                ...
                                                @endif
                                                    ...
                                                    <td>{{ date('d.m.Y H:i:s', $attempt->created_at->getTimestamp()) }}</td>
                                                    <td>
                                                        @if ($attempt->login_result == 'FAILED')
                                                            <span class="label label-danger">NEUSPJEH</span>
                                                        @else
